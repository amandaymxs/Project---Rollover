...
public class Underground {
	...
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println("\nEnter your initial seating amount.");
		...
		System.out.println("\nThe first three rolls of the dealer are:");
		...
		while (true) {
			...
			if (bet == 0) {
				System.out.println("\nYour final holding is $" + chipCount + ".");
			...
			if (userRoll != 1) {
				...
				rollOne = diceRoll.nextInt(6) + 1;
				rollTwo = diceRoll.nextInt(6) + 1;
				System.out.println("\nYou rolled a " + rollOne + " and " + rollTwo + ".");
				...
				if (chipCount <= (initialAmount * 0.1)) {
					while (true) {
						...
						System.out.println("\nEnter the amount you would like to re-buy.");
						...
						System.out.println("\nEnter the amount again to confirm re-buy.");
						int confirmAmount = playRollover.nextInt();
				...
				System.out.println("\nThe last three maximums of each roll are " + m0 + ", " + m1 + ", and " + m2 + ".");
				System.out
						.println("The average of the maximum of the last three rolls is " + ((m0 + m1 + m2) / 3) + ".");
				System.out.println("\nTo play again you can enter your next bet.");
